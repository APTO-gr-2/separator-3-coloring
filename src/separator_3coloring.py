...
def separator_3coloring(G, n):
    ...
    for component in components:
        ...
        for v in component:
            mask[v] = True
        coloring = __sep3col_rec(G, component, coloring, GraphView(G, vfilt=mask), n)

    return coloring


def __sep3col_rec(G, my_component, coloring, view, n):
    if len(view.get_vertices()) < n:
        return three_coloring(G, view, coloring)

    separator = find_separator(G, my_component, False)
    ...
    for sep_coloring in sep_colorings:
        ...
        for component in components:
            ...
            color = __sep3col_rec(G, component, new_coloring, GraphView(view, vfilt=mask), n)
...
if __name__ == "__main__":
    ...
    G, pos = generate_planar_graph(30, 100)
